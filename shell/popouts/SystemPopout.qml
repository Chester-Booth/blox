...
Rectangle {
    ...
    property alias micCanChange: controller.micCanChange
    property alias audioProvider: controller.audioProvider
    ...
    property alias brightnessProvider: controller.brightnessProvider
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: controller.toggleAudio()
                    }
