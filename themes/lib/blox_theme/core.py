...
def derive_shape(theme: dict[str, Any]) -> dict[str, int | float | None]:
    ...
    return {
        ...
        "hyprland_gap": shape.get("window_gap", automatic_gap),
...
""" % (shape["hyprland_gap"], shape["hyprland_gap"], _rgba(c["accent"], "ee"), _rgba(c["success"], "ee"), _rgba(c["border"], "aa"), shape["hyprland_rounding"], _rgba(c["background"], "ee"))
