...
class CliContractTests(unittest.TestCase):
    ...
    def test_system_popout_splits_state_and_mode_sections(self) -> None:
        ...
        self.assertIn("function toggleAudio()", controller)
        self.assertIn("function setMicMuted(value)", controller)
        self.assertIn("audioProvider", controller)
        bar_controller = (REPOSITORY / "shell/services/BarContentController.qml").read_text(encoding="utf-8")
        self.assertIn("function audio(operation: string, value: string)", bar_controller)
    ...
    def test_preview_reports_gtk_restart_and_libadwaita_boundaries(self) -> None:
        ...
        self.assertEqual("Bibata-Modern-Classic", response["data"]["cursor"]["style"])
